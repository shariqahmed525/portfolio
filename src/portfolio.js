...
const greeting = {
  ...
  title: "Hi all, I'm Shariq",
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web and Mobile Applications with JavaScript / ReactJS / NextJS / NodeJS / MongoDB / GraphQL / React Native and some other cool libraries and frameworks."
  ),
  // resumeLink:
...
const socialMediaLinks = {
  ...
  // facebook: "https://www.facebook.com/shariq.ahmed525",
  // medium: "",
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡ Integration of third party services such as Firebase / Twilio / Stripe."
    ),
    emoji(
      "⚡ Written some google calendar scripts to manage schedule system."
    )
  ],
  ...
  experience: [
    {
      ...
      companylogo: require("./assets/images/systems.webp"),
      ...
      footerLink: [
        {
          name: "Certification",
          url:
            "https://graduation.udacity.com/confirm/YDYPUAYY"
        },
      ]
    },
    {
      ...
      footerLink: [
        ...
        {
          name: "Final Project",
          url: "https://sa-classifiedapp.firebaseapp.com/"
        }
      ]
    },
    {
      ...
      image: require("./assets/images/saylani.webp"),
      footerLink: [
        { 
          name: "Certification", 
          url: "https://photos.app.goo.gl/p2ArCVjBcBSYLVPK7" 
        },
      ]
    },
